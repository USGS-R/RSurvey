GetBitmapImage <- function(type) {
  ...
  bits[["find"]]      <- c('0x3c', '0x00', '0x42', '0x00', '0x81', '0x00',
                           ...
                           '0x00', '0x07', '0x00', '0x06')
  bits[["new"]]       <- c('0x70', '0x00', '0x70', '0x00', '0x70', '0x00',
  ...
  bits[["view"]]      <- c('0xff', '0x07', '0xff', '0x07', '0x00', '0x00',
                           ...
                           '0xff', '0x07', '0xff', '0x07', '0x00', '0x00',
                           '0xff', '0x07', '0xff', '0x07')
  bits[["expand"]]    <- c('0xff', '0x07', '0x01', '0x04', '0xff', '0x07',
                           '0x01', '0x04', '0x71', '0x04', '0x71', '0x04',
                           '0xfd', '0x05', '0xf9', '0x04', '0x71', '0x04',
                           '0x21', '0x04', '0xff', '0x07')
  bits[["collapse"]]  <- c('0xff', '0x07', '0x01', '0x04', '0xff', '0x07',
                           '0x21', '0x04', '0x71', '0x04', '0xf9', '0x04',
                           '0xfd', '0x05', '0x71', '0x04', '0x71', '0x04',
                           '0x01', '0x04', '0xff', '0x07')
